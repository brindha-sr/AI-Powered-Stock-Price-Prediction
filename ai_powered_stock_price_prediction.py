# -*- coding: utf-8 -*-
"""AI Powered Stock Price Prediction.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-i8L-qioxZsuo6LYgg-vDC9VTu1XVPFG
"""
...
# 1. Moving Averages — smooth out the price to see the trend
df['MA_20']  = close.rolling(window=20).mean()   # 20-day average
df['MA_50']  = close.rolling(window=50).mean()   # 50-day average

# 2. RSI (Relative Strength Index) — measures if a stock is overbought or oversold
#    RSI > 70 → stock is overbought (might fall)  |  RSI < 30 → oversold (might rise)
delta   = close.diff()
